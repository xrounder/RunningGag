...
int main(int argc, char* argv[]) {
	{
		...
		Vektor2D vektor1(1,1), vektor2 (-5,0);
		float winkel = vektor1.winkel(vektor2);
		cout << "Winkel zwischen (1,1) und (-5,0): " << winkel << endl;
	}
	cout << "Anzahl Matrix-Objekte: " << Matrix::getCounter() << endl;
	return 0;
}
